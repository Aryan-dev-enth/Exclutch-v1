...
class UserController {
  ...
  static register = async (req, res) => {
    try {
      ...
      if (userFound) {
        return res.json({ message: "User already exists!", data: userFound });
      }
  ...
  static getUserById = async (req, res) => {
    try {
      ...
      const user = await User.findOne({ uid }).populate('savedNotes');
  ...
  // Toggle save/unsave a note
  static toggleSavedNote = async (req, res) => {
    try {
